...
/***/ function(module, exports, __webpack_require__) {
	...
	var _exit = __webpack_require__(303);
	...
	var _hunt_and_kill = __webpack_require__(306);

	var _hunt_and_kill2 = _interopRequireDefault(_hunt_and_kill);

	var _canvas_presenter = __webpack_require__(307);

	var _canvas_presenter2 = _interopRequireDefault(_canvas_presenter);

	var _constants = __webpack_require__(304);

	var _dijkstra = __webpack_require__(308);

	var _dijkstra2 = _interopRequireDefault(_dijkstra);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var board = new _board2.default(25, 25);
	var player = new _player2.default();
	var exit = new _exit2.default();
	...
	(0, _hunt_and_kill2.default)(board);

	document.addEventListener('DOMContentLoaded', function () {
	  var canvas = document.getElementById('canvas');
	  canvas.height = board.rows * _constants.CELL_SIZE;
	  canvas.width = board.cols * _constants.CELL_SIZE;

	  (0, _canvas_presenter2.default)(board);
	  ...
	  solveButton.addEventListener('click', function () {
	    var path = (0, _dijkstra2.default)(board, player.cell, exit.cell).reverse();

	    var _loop = function _loop(i) {
	      setTimeout(function () {
	        var cell = path[i];
	        var breadCrumbs = new _player2.default();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Board = function () {
	  ...
	  _createClass(Board, [{
	    ...
	    value: function prepare() {
	      ...
	      for (var row = 0; row < this.rows; row++) {
	        ...
	        for (var col = 0; col < this.cols; col++) {
	          rowArray[col] = new _cell2.default(row, col);
	        }
	    ...
	    key: "insertObject",
	    value: function insertObject(object) {
	    ...
	    key: "placeExit",
	    value: function placeExit(object) {
	      // TODO: random placement.
	      var cell = this.get(0, 0);
	      cell.contents = object;
	      object.cell = cell;
	    }
	  }, {
	    ...
	    value: function configureCells() {
	      ...
	      this.eachCell(function (cell) {
	        ...
	        cell.north = _this.get(row - 1, col);
	        cell.south = _this.get(row + 1, col);
	        cell.west = _this.get(row, col - 1);
	        cell.east = _this.get(row, col + 1);
	      });
	    }
	  }, {
	    key: "eachCell",
	    value: function eachCell(cb) {
	    ...
	    value: function randomCell() {
	      var randomRow = (0, _utils.sample)(this.grid);
	      return (0, _utils.sample)(randomRow);
	    }
	  }]);
	...
	var Cell = function () {
	  ...
	  _createClass(Cell, [{
	    ...
	    value: function link(cell) {
	      var linkBoth = arguments.length <= 1 || arguments[1] === undefined ? true : arguments[1];
	    ...
	    value: function unlink(cell) {
	      var unlinkBoth = arguments.length <= 1 || arguments[1] === undefined ? true : arguments[1];

	      this.links = this.links.filter(function (c) {
	        return c !== cell;
	      });
	      if (unlinkBoth) {
	...
	var Exit = function () {
	  ...
	  _createClass(Exit, [{
	    ...
	    value: function draw(ctx) {
	      var startX = this.cell.x * _constants.CELL_SIZE;
	      var startY = this.cell.y * _constants.CELL_SIZE;
	      ctx.fillStyle = 'green';
	      ctx.fillRect(startX, startY, _constants.CELL_SIZE, _constants.CELL_SIZE);
	      ctx.fillStyle = 'black';
	    }
	  }]);
...
/***/ function(module, exports) {
	...
	var CELL_SIZE = exports.CELL_SIZE = 25;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Player = function () {
	  ...
	  _createClass(Player, [{
	    key: 'draw',
	    value: function draw(ctx) {
	      var startX = this.cell.x * _constants.CELL_SIZE + 5;
	      var startY = this.cell.y * _constants.CELL_SIZE + 5;

	      ctx.fillRect(startX, startY, _constants.CELL_SIZE - 10, _constants.CELL_SIZE - 10);
	    }
	  }, {
	    key: 'getDesiredCell',
	    value: function getDesiredCell(direction) {
	      switch (direction) {
	        case 'north':
	    ...
	    value: function move(direction) {
	      var desiredCell = this.getDesiredCell(direction);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function huntAndKill(board) {
	  ...
	  var current = board.randomCell();
	  while (current !== null) {
	    var unvisitedNeighbours = current.neighbours().filter(function (cell) {
	      return Object.keys(cell.links).length === 0;
	    });
	    if (unvisitedNeighbours.length > 0) {
	      neighbour = (0, _utils.sample)(unvisitedNeighbours);
	      current.link(neighbour);
	      current = neighbour;
	    } else {
	      current = null;

	      board.eachCell(function (cell) {
	        var visitedNeighbours = cell.neighbours().filter(function (innerCell) {
	          return Object.keys(innerCell.links).length !== 0;
	        });
	        if (Object.keys(cell.links).length === 0 && visitedNeighbours.length !== 0) {
	          current = cell;
	          neighbour = (0, _utils.sample)(visitedNeighbours);
	          current.link(neighbour);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function drawBoardtoCanvas(board) {
	  ...
	  board.eachCell(function (cell) {
	    var startX = cell.x * _constants.CELL_SIZE;
	    var startY = cell.y * _constants.CELL_SIZE;
	    var endX = startX + _constants.CELL_SIZE;
	    var endY = startY + _constants.CELL_SIZE;
	...
	exports.default = drawBoardtoCanvas;
...
/***/ function(module, exports) {
	...
	function solve(grid, start, end) {
	  ...
	  var _loop = function _loop() {
	    var cellHash = getNextCell(knownCells);
	    var cell = cellHash.cell;
	    var neighbours = cell.neighbours().filter(function (n) {
	      var hasVisted = !Object.keys(visitedCells).includes(n.toString());
	      var isLinked = cell.isLinked(n);
	  ...
	  while (!path.includes(start)) {
	    ...
	    var _cellHash = visitedCells[currentPos.toString()];
	    currentPos = _cellHash.prev;
	  }
	  return path;
	}

	function getNextCell(knownCells) {
	  var cells = Object.values(knownCells).sort(function (a, b) {
